...
(function () {
        ...
        if(connections.length==0)
        {
            Swal.fire({
               ...
               position:'center',
                ...
                html: 'Please connect the components as mentioned below:<br>(1-3), (2-4), (5-7), (6-8)',
               icon:'error'
                });
               return false
        }
    ...
    jsPlumb.ready(function () {
        ...
        instance.batch(function () {
            ...
            Point.push(instance.addEndpoint("dragDropWindow3", { anchor: [0.75,0 , 0, -1] }, exampleEndpoint4));
            Point.push(instance.addEndpoint("dragDropWindow4", { anchor: [0.75, 0, 0, -1] }, exampleEndpoint4));
